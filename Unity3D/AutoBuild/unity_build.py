...
#Windows
unity_command = "D:\\Unity4.7.2\\Editor\\Unity.exe -projectPath D:\Unity3D\AutoBuild -executeMethod ProjectBuild.BuildForIPhone -quit"
os.system(cmd)

#MAC
#unity_command = "/Applications/Unity/Unity.app/Contents/MacOS/Unity -projectPath /Users/zwwx/work/Unity3D/AutoBuild/ -executeMethod ProjectBuild.BuildForIPhone -quit"